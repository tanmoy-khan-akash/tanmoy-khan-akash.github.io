<div align="center">
  <h1><a>Simple Tetris Implementation</a></h1>
  <br>
  <h2><a>Simple Tetris implementation in C and OpenGL.</a></h2>
</div>
...
For the web version use a web server (See [above](#requirements)) to host the website.
